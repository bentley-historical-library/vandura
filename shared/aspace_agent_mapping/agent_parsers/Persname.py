...
from vandura.shared.aspace_agent_mapping.agent_parsers.create_persname_json import parse_persname
...
class Persname:
    ...
    def reduce_dict(data_dict):
        aspace_dict = {}
        keys = [u"primary_name", u"title", u"name_order", u"prefix", u"dates", u"rest_of_name", u"suffix", u"fuller_form", u"number", u"name_order", u"sort_name_auto_generate", u"source", u"authority_id"]
